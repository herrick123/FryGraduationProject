...
<body>
	...
	<form name="demoForm" id="demoForm"
		...
		<div class="row" style="margin-top: 10px;">
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">数据源名称：</span> <input type="text"
						...
						readonly="readonly" value="数据源A" aria-describedby="sizing-addon2">
				</div>
			</div>
			<div class="col-md-4"></div>
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">数据库类型：</span> <input type="text"
						class="form-control" id="dataSourceType" name="dataSourceType" value="JDBC"
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">数据库版本：</span> <input type="text"
						class="form-control" id="version" name="version" value="1.1"
						readonly="readonly" aria-describedby="sizing-addon2">
				</div>
			</div>
				<div class="col-md-4"></div>
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">数据库访问路径：</span> <input type="text"
						class="form-control" id="URL" name="URL" value="https://www.baidu.com/"
						readonly="readonly" aria-describedby="sizing-addon2">
				</div>
			</div>
			<div class="col-md-4"></div>
