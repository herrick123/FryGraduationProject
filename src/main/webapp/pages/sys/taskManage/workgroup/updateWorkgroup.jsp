...
<body>
	<div class="sodb-page-home">
		<ul class="sodb-page-ul">
			...
			<li><a href="#">工作组配置</a><i class="fa fa-angle-right"></i></li>
			<li><a href="#">修改工作组</a></li>
		</ul>
	</div>
	...
	<form name="demoForm" id="demoForm"
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">工作组名称：</span> <input type="text"
						class="form-control" id="workgroupName" name="workgroupName"
						readonly="readonly" value="工作组A" aria-describedby="sizing-addon2">
				</div>
			</div>
			<div class="col-md-4"></div>
		</div>
		<div class="row" style="margin-top: 10px;">
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">工作组描述：</span> 
					<textarea class="form-control" id="describe" name="describe" cols="4" rows="15"
						readonly="readonly" aria-describedby="sizing-addon2">这是工作组A的描述
						</textarea>
				</div>
			</div>
			<div class="col-md-4"></div>
