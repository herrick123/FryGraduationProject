...
<body>
	<div class="sodb-page-home">
		<ul class="sodb-page-ul">
			...
			<li><a href="#">工作组管理</a><i class="fa fa-angle-right"></i></li>
			<li><a href="#">添加工作组</a></li>
		</ul>
	</div>
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon">工作组名称：</span> <input type="text"
						class="form-control" id="wordgroupName" name="wordgroupName"
			...
			<div class="col-md-4">
				<div class="input-group">
					...
					<textarea class="form-control" id="describe" name="describe" cols="4"
						rows="15" aria-describedby="sizing-addon2"></textarea>
				</div>
			</div>
			<div class="col-md-4"></div>
		</div>
