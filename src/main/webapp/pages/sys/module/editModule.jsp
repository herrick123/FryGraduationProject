...
<form name="moduleForm" class="form-horizontal" id="moduleForm" action="<c:url value='/module/update' />" method="post">
	<input type="hidden" name="moduleId" id="moduleId"  value="<c:out value='${ module.moduleId }' />"/>
	<div class="row" style="margin-top: 50px;">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" id="moduleName" name="moduleName" value="<c:out value='${ module.moduleName }' />" placeholder="模块名称"
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" id="moduleUrl" name="moduleUrl" placeholder="模块URL"  value="<c:out value='${ module.moduleUrl }' />" 
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" id="displayIndex" name="displayIndex" placeholder="显示顺序"  value="<c:out value='${ module.displayIndex }' />"
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" id="moduleGroup" name="moduleGroup" placeholder="模块组"  value="<c:out value='${ module.moduleGroup }' />"
>
			</div>
	...
	<div class="row" style="margin-top: 20px;">
		<div class="col-md-10" style="text-align: center;">
			<button class="sbtn sbtn-blue" type="button" id="subBtn" onclick="submitModule()">提交</button>
			...
			success : function(element, css){
				...
				if($(element).attr('name') == 'moduleUrl'){
					...
					$.ajax({
						...
						dataType : "json",
						url : '<c:url value="/module/check" />',
						data : "moduleUrl=" + moduleUrl + "&moduleId=" +moduleId,
						success : function(Data, textStatus) {
							if (Data.returncode == '10000') {
								$(element).parents('.form-group').addClass(css.failure);
