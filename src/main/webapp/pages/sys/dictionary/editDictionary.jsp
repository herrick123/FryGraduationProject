...
<body style="overflow: hidden; ">
	...
	<form name="dictForm" class="form-horizontal" id="dictForm" action="<c:url value='/dictionary/update' />" method="post">
		<input type="hidden" name="id" id="did" value="<c:out value='${ dict.id }' />" />
		...
		<div class="row" style="margin-top: 50px;">
			<div class="form-group">
				...
				<div class="col-md-4  ">
					<input type="text" class="form-control" id="typeName"
					 name="typeName" placeholder="请输入字典类别名称" value="<c:out value='${ dict.typeName }' />"
			...
			<div class="form-group">
				...
				<div class="col-md-4  ">
					 ...
					 name="typeCode" placeholder="请输入字典类别值" value="<c:out value='${ dict.typeCode }' />"
			...
			<div class="form-group">
				...
				<div class="col-md-4  ">
					<textarea class="form-control" id="describe" name="describe" placeholder="请输入字典类别描述：" valid="r|le1-le255" validTitle="必填项" validInfoArea="show_describe_area">${ dict.describe}</textarea>
				</div>
		...
		<div class="row" style="margin-top: 20px;">
			<div class="col-md-11" style="text-align: center;">
				<button class="sbtn sbtn-blue sbtn30" type="button" id="subBtn" onclick="submit_dict">保存</button>
