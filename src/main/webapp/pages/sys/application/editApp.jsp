...
<body>
	<div class="sodb-page-home">
		<ul class="sodb-page-ul">
			...
			<li>
				<a href="#">应用管理</a><i class="fa fa-angle-right"></i>
			</li>
			<li>
				<a href="#">编辑应用信息</a>
			</li>
	...
	<form name="appForm" class="form-horizontal" id="appForm" action="<c:url value='/application/update' />" method="post">
		<input type="hidden" name="id" id="appId" value="<c:out value='${ app.id}' />"/>
		<div class="row" style="margin-top: 50px;">
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					name="appName" placeholder="请输入应用名称" aria-describedby="sizing-addon2" 
						valid="r|le2-le18" validTitle="必填项" validInfoArea="show_name_area"
					required="required" value="<c:out value='${ app.appName }' />">
				</div>
				<div class="col-md-4 help-block" id="show_name_area"></div>
			</div>
			<br>
			<div class="form-group">
				<span for="appName" class="col-sm-4 control-label">应用上线文根：</span>
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="appContext" 
					name="appContext" placeholder="请输入应用上线文根" aria-describedby="sizing-addon2"
					 valid="r" validTitle="必填项" validInfoArea="show_context_area"
					value="<c:out value='${ app.appContext }' />">
				</div>
				<div class="col-md-4 help-block" id="show_context_area"></div>
			</div>
			<br>
			<div class="form-group">
				<span for="appName" class="col-sm-4 control-label">应用显示顺序：</span>
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="displayIndex" 
					name="displayIndex" placeholder="请输入应用显示顺序" aria-describedby="sizing-addon2"
					valid="r|le1-le10|number" validTitle="必填项" validInfoArea="show_display_area"
					value="<c:out value='${ app.displayIndex}' />">
				</div>
				<div class="col-md-4 help-block" id="show_display_area"></div>
			</div>
			<br>
			<div class="form-group">
				<span for="appName" class="col-sm-4 control-label">应用简介：</span>
				<div class="col-md-4">
					<textarea class="form-control input-radius" id="appDesc" name="appDesc" 
						placeholder="请输入应用简介" aria-describedby="sizing-addon2"
						valid="r|le1-le255" validTitle="必填项" validInfoArea="show_desc_area">
						<c:out value='${ app.appDesc}' />
					</textarea>
				</div>
