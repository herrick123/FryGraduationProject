					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-6" style="margin-bottom: 10px;">
								...
								value="李龙" readonly="readonly">
							</div>
							<label class="col-md-4 control-label">所在区域：
							<span class="required">* </span>
							</label>
							<div class="col-md-6" style="margin-bottom: 10px;">
								<input type="text" class="form-control" 
									value="航站区" readonly="readonly">
							</div>
							<label class="col-md-4 control-label">摄像机编号：
							<span class="required">* </span>
							</label>
							<div class="col-md-6" style="margin-bottom: 10px;">
								<input type="text" class="form-control" 
							...
							<label class="col-md-4 control-label">区域：
							<span class="required">* </span>
							</label>
							<div class="col-md-6" style="margin-bottom: 10px;">
								<input type="text" class="form-control" 
