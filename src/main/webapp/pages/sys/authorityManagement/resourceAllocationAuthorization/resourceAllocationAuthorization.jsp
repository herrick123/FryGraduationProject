...
<div class="portlet box blue-hoki">			
		<div class="portlet-title">
			...
			<div style="margin-left:92%;padding-top:4px;">
				<button type="button" class="sbtn sbtn-default" onclick="window.location.href='#'">新增用户</button>
			</div>
		</div>			
		<div class="portlet-body form"> 
			...
			<div id="resourcepolicehold" class="dlshouwen-grid-container" style="margin-top:5px;"></div>
			<div id="resourcepolice" class="dlshouwen-grid-toolbar-container"></div>
</div>
</div>
</div>
</div>
...
{ "name":"张全" , "role":"运维员","function":"视频监控调用","time":"2017-6-22"}
	...
	var resourcegridColumns = [    	
     ...
     var resourcegridOption = {
     	lang : 'zh-cn',
     	ajaxLoad : false,
     	exportFileName : '用户列表',
     	datas : resourcedatas,
     	columns : resourcegridColumns,
     	gridContainer : 'resourcepolicehold',
     	toolbarContainer : 'resourcepolice',
     	tools : '',
     	pageSize : 10,
     	pageSizeLimit : [10, 20, 50]
     };
     var resourcegrid = $.fn.dlshouwen.grid.init(resourcegridOption);
     $(function(){
    	 resourcegrid.load();
     })	  
})
