...
<form class="form-inline" id="eventAlarmForm" action="#" method="post">
	...
	<div class="row">
		<div class="row" style="display:none;">
			...
			<div class="col-md-3" style="text-align: right;">${eventConfirm.handleMan }</div>
	...
	<div class="row">
		...
		<input class="col-md-3" id="handleMan" name="handleMan"
			style="text-align: left; border: 1px solid #ccc; border-radius: 3px;" value="${loginUser.userName }"/>
		<div class="col-md-2" style="text-align: right;"></div>
		<div class="col-md-3"></div>
		<div class="col-md-1" style="text-align: right;"></div>
	</div>
	...
	<div class="safeanniu" style="text-align: center">
		<input type="button" value="提交" id="alarmEvent" class="sbtn sbtn-blue sbtn30"/> 
		<input type="button"
...
$(document).ready(function(){	
	$("#alarmEvent").click(function(){
		var eventId = $("#eventId").val();
		$.ajax({
			url: "<c:url value='/event/updateEventAlarm' />",
			type:"POST",
		 	data:$("#eventAlarmForm").serialize(),
		 	dataType:'json',
		 	success : function(data, textStatus) {
	 			if (data.returncode == '200'){	
	 				window.location.href = '<c:url value='/event/eventAlarmList' />';
