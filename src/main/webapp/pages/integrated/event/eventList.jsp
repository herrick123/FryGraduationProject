...
<div style="width: 100%; padding: 0px 10px;">
	<form class="form-inline" style="margin: 10px 0px 10px 0px;">
		<input type="hidden" class="form-control" id="eventSource" value="1">
	...
	<div class="tabbable" style="margin-top:10px;">
		<div class="row">
			<button type="button" class="sbtn sbtn-blue" style="float:right;" id="addBtn">安全事件录入</button>
		</div>
...
var manualColumns = [
    ...
    {id:'alarmContact', title:'报警人联系方式', type:'string',  columnClass:'text-center'},
...
$(function(){
	...
	manualGrid.parameters['eventSource'] = "1";
