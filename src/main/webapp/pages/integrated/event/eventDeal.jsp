...
<form class="form-inline" id="eventDealForm" action="#" method="post">
	...
	<div class="row">
		...
		<input class="col-md-3"
			style="text-align: left; border: 1px solid #ccc; border-radius: 3px;" id="handleMan" name="handleMan" value="${loginUser.userName }" />
		<div class="col-md-2" style="text-align: right;"></div>
		<div class="col-md-3"
			></div>	
		<div class="col-md-3"></div>
	...
	<div class="row">
		...
		<div class="col-md-6" style="padding: 0px">
			<textarea id="handleNote" name="handleNote" style="height: 100px; width:600px;"></textarea>
		</div>
		<div class="col-md-3"></div>
	</div>
	<div class="safeanniu" style="text-align: center">
		<input type="button" value="提交" id="dealEvent" class="sbtn sbtn-blue sbtn30"/> 
		<input type="button"
...
$(document).ready(function(){	
	$("#dealEvent").click(function(){
		var eventId = $("#eventId").val();
		$.ajax({
			url: "<c:url value='/event/updateEventDeal' />",
			type:"POST",
		 	data:$("#eventDealForm").serialize(),
		 	dataType:'json',
		 	success : function(data, textStatus) {
	 			if (data.returncode == '200'){	
	 				window.location.href = '<c:url value='/event/eventDealList' />';
