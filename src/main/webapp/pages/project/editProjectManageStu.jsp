...
<body style="overflow: hidden;">
	...
	<form name="addProjectForm" class="form-horizontal " id="addProjectForm"  action="<c:url value='/projectManage/updataStu?employeeId=${staffId}&id=${id}' />" method="post">
	<input type="hidden" name="id" id="id" value="<c:out value='${projectManageEntity.id}' />"/>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="projectCode"
						...
						value="<c:out value='${projectManageEntity.projectCode}' />"readonly="readonly">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="projectName"
						...
						aria-describedby="sizing-addon2" required="required"
						value="<c:out value='${projectManageEntity.projectName}' />"readonly="readonly">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="owner"
						...
						aria-describedby="sizing-addon2" required="required"
						value="<c:out value='${projectManageEntity.owner}' />"readonly="readonly">
				</div>
			</div>
			<div class="form-group">
					...
					<div	 class="col-md-8" style="margin-top: 5px;float-left:1px;">
				  		<c:forEach var="type" items="${types }">
			  				<c:if test="${type.valueCode eq projectManageEntity.type }">
			  					<input type="radio" checked="checked"  name="type" value="${type.valueCode }"/>${type.valueName }
				  			</c:if> 
				  			<c:if test="${type.valueCode != projectManageEntity.type }">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text"
						...
						value="<fmt:formatDate value='${ projectManageEntity.startTime}' pattern='yyyy/MM/dd'/>"
						readonly="readonly">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text"
						...
						value="<fmt:formatDate value='${ projectManageEntity.endTime}' pattern='yyyy/MM/dd'/>"
						readonly="readonly">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="projectLeader"
						...
						aria-describedby="sizing-addon2" required="required"
						value="<c:out value='${projectManageEntity.projectLeader}' />"
						readonly="readonly">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control input-radius" id="staff"
						...
						aria-describedby="sizing-addon2" required="required"
						value="<c:out value='${projectManageEntity.staff}' />">
